 ...
 * <p>Not yet wired into the update/render loop — see GameUpdater / RenderPipeline.
 * Construct with an initial scene, then call {@link #switchTo(Scene)} to transition.</p>
 */
