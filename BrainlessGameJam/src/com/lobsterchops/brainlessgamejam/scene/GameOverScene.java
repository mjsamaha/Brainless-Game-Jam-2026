...
public class GameOverScene implements Scene {
    ...
    public GameOverScene(SceneManager sceneManager, Scene menuScene,
                         Runnable restartCallback, EventBus eventBus) {
    ...
    public void render(Graphics2D g2) {
        ...
        // "GAME OVER" title
        drawCentred(g2, FONT_TITLE, ColorConfig.HUD_BANNER_TITLE,
                "GAME OVER", W, centreY - 90);
 
        // Score
        drawCentred(g2, FONT_LABEL, ColorConfig.HUD_SCORE_LABEL,
                "SCORE", W, centreY - 20);
        drawCentred(g2, FONT_VALUE, ColorConfig.HUD_SCORE_VALUE,
                String.format("%06d", finalScore), W, centreY + 10);
 
        // Wave reached
        drawCentred(g2, FONT_LABEL, ColorConfig.HUD_WAVE_LABEL,
                "WAVE REACHED", W, centreY + 46);
        drawCentred(g2, FONT_VALUE, ColorConfig.HUD_WAVE_VALUE,
                String.valueOf(waveReached), W, centreY + 72);
        ...
        drawCentredAlpha(g2, FONT_VALUE, ColorConfig.HUD_SCORE_VALUE,
        		"PRESS  ENTER  TO  RESTART", W, centreY + 160, alpha);
    }
    ...
    private void drawCentred(Graphics2D g2, Font font, Color colour,
                              String text, int screenW, int y) {
        g2.setFont(font);
    ...
    private void drawCentredAlpha(Graphics2D g2, Font font, Color colour,
                                  String text, int screenW, int y, float alpha) {
