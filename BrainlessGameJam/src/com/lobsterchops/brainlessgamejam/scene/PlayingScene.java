...
/**
 * <h4>Wraps the existing gameplay loop (GameSystem + RenderPipeline) as a
 * {@link Scene}.</h4>
 *
 * <p>
 * This is an adapter only — it does not change how GameSystem or RenderPipeline
 * behave. Update/render calls are simply forwarded.
 * </p>
 *
 * <p>
 * Collision reactions for swarm entities are wired here in {@link #enter()} via
 * the {@link EventBus}, and cleared on {@link #exit()} via
 * {@code eventBus.clear()}.
 * </p>
 */
