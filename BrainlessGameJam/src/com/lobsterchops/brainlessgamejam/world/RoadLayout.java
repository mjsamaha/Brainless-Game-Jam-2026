...
public class RoadLayout {
    ...
    /**
     * Removes all Car objects from the game system — call before spawning a new wave.
     */
    ...
    /**
     * Scans the tile map row by row and returns the world-space Y centre
     * of each row that contains a ROAD_YELLOW tile (the lane centre marker).
     * Falls back to any ROAD tile row if no yellow strips are found.
     */
