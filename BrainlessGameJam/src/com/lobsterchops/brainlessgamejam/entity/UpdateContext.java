...
public record UpdateContext(GameSystem gameSystem, long tick, long elapsedMillis, float fixedDeltaSeconds) {

	public static UpdateContext fixed(GameSystem world, long tick, long elapsedMillis) {
		return new UpdateContext(world, tick, elapsedMillis, 1f / GameLoopConfig.TARGET_FPS);
	}
