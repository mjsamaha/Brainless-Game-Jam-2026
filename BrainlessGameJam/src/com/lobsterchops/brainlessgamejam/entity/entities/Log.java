...
public class Log extends Entity {
	...
	private static final BufferedImage SPRITE = AssetManager.get(Gfx.LOG, (int) WIDTH, (int) HEIGHT);
	...
	public void render(Graphics2D g2) {
		...
		if (SPRITE != null) { // Draw the log sprite if available
			drawSprite(g2, drawX, drawY);

		} else { // Fallback: draw a brown rectangle with dark edges if the sprite is missing
