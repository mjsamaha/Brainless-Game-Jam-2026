...
public class DebugRenderer {
    ...
    private List<DebugLine> buildRightLines(GameSystem gameSystem) {
        ...
        return List.of(
            ...
            new DebugLine(null, "Java " + System.getProperty("java.version") + " (" + System.getProperty("java.vendor") + ")"),
            DebugLine.BLANK,

            // CPU
            new DebugLine("cpu",     System.getProperty("os.arch")),
            new DebugLine("cores",   rt.availableProcessors()),
            DebugLine.BLANK,

            // Memory
            new DebugLine("mem used",  usedMb + " MB"),
            new DebugLine("mem total", totalMb + " MB"),
            new DebugLine("mem max",   maxMb + " MB"),
            DebugLine.BLANK,

            // Display
            new DebugLine("display", getDisplayInfo()),
            DebugLine.BLANK,

            // Game
            new DebugLine("state",   gameSystem.getState()),
            new DebugLine("tick",    gameSystem.getTick()),
